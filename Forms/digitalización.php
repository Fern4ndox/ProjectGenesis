                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="contact-info">
                                <li><i class="icon-folder-upload"></i>ID Documento</li>
                                <li><i class="icon-user-tie"></i>Login</li>
                                <li><i class="icon-checkmark"></i>Id Expediente Requisito</li>
                                <li><i class="icon-file-pdf"></i>Nombre Archivo</li>
                                <li><i class="icon-calendar"></i>Fecha</li>
                            ...
                            <div class="row">
                                <div class="col-md-pull-12">
                                    <div class="form-group">
                                        <input type="text" id="ID" class="form-control" placeholder="ID Documento" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="Login"  placeholder="Login" required="yes">
                                        /*Desde un Select toma los datos y asigna de una vez. O algo parecido*/
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="ID_ExpReq"  placeholder="ID Expediente Requisito" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="NombreArc"  placeholder="NombreArchivo" required="yes">
                                        /*Tomá la información desde el Login*/
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="date" id="fecha" class="form-control" placeholder="Fecha Ingreso" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" id="AñoPresent" class="form-control" placeholder="URL" required="yes">
                                    </div>
                                </div>
                            </div>
                        </div>
