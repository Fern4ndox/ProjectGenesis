        ...
        <div id="fh5co-contact" class="animate-box">
            <div class="container">
                <form action="#">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="section-title">Información Requisito</h3>
                            <p>Por favor ingresar la información correspondiente a la persona Requisito</p>
                            <ul class="contact-info">
                                <li><i class="icon-list-numbered"></i>ID</li>
                                <li><i class="glyphicon-folder-open"></i>Id Expediente Requisito</li>
                                <li><i class="icon-add-to-list"></i>Descripción Requisito</li>
                                <li><i class="icon-database"></i>Observaciones</li>
                                <li><i class="icon-checkmark"></i>Obligatorio</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-pull-12">
                                    <div class="form-group">
                                        <select name="state" id="ID_ExpeRequisito"  class="form-control selectpicker" required="yes">
                                            <option value=" " >ID Expediente Requisito</option>
                                ...
                                <div class="col-md-pull-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="DescripcionReq"  placeholder="Descripción Requisito" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-pull-12">
                                    <div class="form-group">
                                        <input type="textarea" class="form-control" id="Observaciones"  placeholder="Observaciones" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-pull-12">
                                    <div class="form-group">
                                        <select name="state" id="Obligatorio"  class="form-control selectpicker" required="yes">
