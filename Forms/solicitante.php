        ...
        <div id="fh5co-contact" class="animate-box">
            <div class="container">
                <form action="#">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="section-title">Información Solicitante</h3>
                            <p>Por favor ingresar la información correspondiente al Solicitante</p>
                            <ul class="contact-info">
                                <li><i class="icon-user-tie"></i>Id Solicitante</li>
                                <li><i class="icon-folder"></i>ID Expediente Requisito</li>
                                <li><i class="icon-make-group"></i>ID Persona Dependiente</li>
                                <li><i class="icon-new"></i>Número Documento</li>
                                <li><i class="icon-user-tie"></i>DPI Solicitante</li>
                                <li><i class="icon-list"></i>Nombre Completo</li>
                                <li><i class="icon-calendar2"></i>Fecha Nacimiento</li>
                                <li><i class="icon-home"></i>Dirección</li>
                                <li><i class="icon-phone2"></i>Teléfono</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="ID" class="form-control" placeholder="ID Solicitante" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="state" id="ID_Expediente"  class="form-control selectpicker" required="yes">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="ID_PersonaDep"  placeholder="Personas Dependientes" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="Documento"  placeholder="Numero Documento" required="yes">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
